import {
  ...
  call_exports,
  mini_exports
} from "./chunk-SM27GMPU.js";
import "./chunk-GNW55RGI.js";
import "./chunk-QZQH7SPI.js";
...
import {
  ...
  injected,
  mock
} from "./chunk-F5TI2GSS.js";
import "./chunk-EDDRWZDP.js";
import "./chunk-7CTHU3HB.js";
import "./chunk-LWLUVSGB.js";
import {
  withRetry,
  withTimeout
} from "./chunk-7HTZYT5V.js";
import "./chunk-GXBBL4VZ.js";
import "./chunk-J4JL2KAQ.js";
import {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-REKKDQAL.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-HQVSLPUG.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-LGWRXATE.js");
    ...
    return {
      ...
      async getProvider() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./_dist-YIU4NDO6.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-W7BDS2B2.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-LRWELPPW.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-3JNLJO5N.js");
